...
<c:if test="${empty list }"><p>등록된 후기가 없습니다.</p></c:if>

<c:forEach var="vo" items="${list }">
<input type="button" value="수정" onclick="location.href='${pageContext.request.contextPath }/review/edit.do?review_num=' + ${vo.review_num}">
